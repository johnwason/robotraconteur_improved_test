...
class TestServerNodeConfig:
    def __init__(self,nodename):
        ...
        if node_env is not None:
            ...
            t2=testroot_impl(t)
            self.node.RegisterService("RobotRaconteurTestService","com.robotraconteur.testing.TestService1.testroot",t2)
            ...
            self.node.RegisterService("RobotRaconteurTestService_auth","com.robotraconteur.testing.TestService1.testroot",t3,s)

            t4=testroot3_impl()
            c = self.node.RegisterService("RobotRaconteurTestService2","com.robotraconteur.testing.TestService3.testroot3",t4)
            c.RequestObjectLock("RobotRaconteurTestService2.nolock_test", "server")

            t3=asynctestroot_impl()
            c = self.node.RegisterService("RobotRaconteurTestService3","com.robotraconteur.testing.TestService5.asynctestroot",t3)
