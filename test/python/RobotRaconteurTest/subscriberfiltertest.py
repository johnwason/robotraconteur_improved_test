...
def main():
    ...
    if (len(sys.argv) >= 4):
        ...
        if (subcommand == "nodeid"):
            if (len(sys.argv) < 4):
                raise Exception("Usage for subscriberfiltertest:  subscriberfiltertest nodeid <nodeid>")
            ...
            if (len(sys.argv) < 4):
                raise Exception("Usage for subscriberfiltertest:  subscriberfiltertest nodename <nodename>")
            ...
            if (len(sys.argv) < 5):
                raise Exception("Usage for subscriberfiltertest:  subscriberfiltertest nodeidscheme <nodeid> <schemes>")
            ...
            if (len(sys.argv) < 6):
                raise Exception("Usage for subscriberfiltertest:  subscriberfiltertest nodeidauth <nodeid> <username> <password>")
            ...
            if (len(sys.argv) < 4):
                raise Exception("Usage for subscriberfiltertest:  subscriberfiltertest servicename <servicename>")                
